var searchCadastreRM = (function () {
    ...
    var selectCityInput = '<select id="communeSearch" name="communeSearch" class="form-control">'
							+	'<option value="" disabled selected> rechercher la commune de la parcelle</option> </select>';
