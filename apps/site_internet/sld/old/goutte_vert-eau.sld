...
<!--
  ...
  nom du SLD : v_sitorg_organisme_goutte_vert-eau_unisize
  
  couche source dans la base :  serv_equipub.v_sitorg_organisme
  layer cible du style       :  eq_poi:v_sitorg_organisme
  
  objet : goutte vert-eau pour les cartes de la DG Comm mais taille unique car peu d'objets à afficher en même temps
...
xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>v_sitorg_organisme_goutte_vert-eau_unisize</se:Name>
        <se:Description>
          <se:Title>Organismes (picto vert-eau)</se:Title>
          <se:Abstract>Style simple : goutte d'eau vert-eau</se:Abstract>
        </se:Description>
      <se:FeatureTypeStyle>
