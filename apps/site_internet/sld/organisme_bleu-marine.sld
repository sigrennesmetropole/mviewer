...
xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>v_siteinternet_goutte_bleu_marine_unisize</se:Name>
        <se:Description>
          <se:Title>Organismes (picto bleu marine)</se:Title>
          <se:Abstract>Style simple : goutte d'eau bleu marine</se:Abstract>
        </se:Description>
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:ExternalGraphic>
                <se:OnlineResource  xlink:type="simple" xlink:href="https://public.sig.rennesmetropole.fr/ressources/img/mviewer/marker_bleu-marine.png" />
