...
<!--
  ...
  layer cible du style       :  trp_doux:parc_velo_securise
...
xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <se:Name>trp_doux:parc_velo_securise</se:Name>
    <UserStyle>
      <se:Name>parc_velo_securise_goutte_verte</se:Name>
        <se:Description>
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          <se:Name>Parcs vélos sécurisés</se:Name>
          <se:MinScaleDenominator>1</se:MinScaleDenominator>
          <se:MaxScaleDenominator>500000</se:MaxScaleDenominator>
          <se:PointSymbolizer>
            <se:Graphic>
              <se:ExternalGraphic>
                <se:OnlineResource  xlink:type="simple" xlink:href="https://public.sig.rennesmetropole.fr/ressources/img/mviewer/marker_parcVeloSecurise.png" />
